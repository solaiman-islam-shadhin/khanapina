      ...
      <div className="card w-full max-w-sm  md:max-w-md bg-base-100 shadow-2xl">
        <div className="card-body p-4 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <button type="submit" className="btn btn-primary btn-sm sm:btn-md w-full font-play text-sm sm:text-base md:text-lg" disabled={loading}>
          ...
          <button onClick={handleGoogle} className="btn btn-outline btn-sm sm:btn-md w-full font-play text-xs sm:text-sm md:text-base" disabled={googleLoading}>
            {googleLoading ? (
